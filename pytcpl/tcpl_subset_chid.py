...
def tcpl_subset_chid(dat, flag=False):
    ...
    # a chid can have more than one spid! Use consensus logic
    ...
    dat = dat.sort_values(by=["aeid", "chid", "fitc_ordr", "max_med"],  # "nflg",
                          ascending=[True, True, True, False], na_position="last")  # True, 
